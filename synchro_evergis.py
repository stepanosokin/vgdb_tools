...
if __name__ == '__main__':
    ...
    # # new well
    # synchro_table([('dm', ['well_attributes', 'well_attribute_names', 'links'])], '.pgdsn', '.ext_pgdsn', ssh_host=egssh["host"], ssh_user=egssh["user"], bot_info=bot_info)
    # synchro_layer([('dm', ['wells'])], local_pgdsn, ext_pgdsn, ssh_host=egssh["host"],
    #               ssh_user=egssh["user"], bot_info=bot_info)
